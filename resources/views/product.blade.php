...
<div class="custom-product" style="margin:20px;">
	...
	<div class="wrap-main-slide">
		<div class="slide-carousel owl-carousel style-nav-1" data-items="1" data-loop="1" data-nav="true"
			data-dots="false">
			@foreach ($banner as $slide)<div id='n1' style="background-color: red;width:100%;">tuhin000000</div>
	...
	<div class="wrap-banner style-twin-default">
		<div class="banner-item">
			<a href="#" class="link-banner banner-effect-1">
				<figure><img src="{{ asset('images/tinybanner/tinybanner-1.png') }}" alt="" width="580" height="190">
				</figure>
			</a>
		</div>
		<div class="banner-item">
			<a href="#" class="link-banner banner-effect-1">
				<figure><img src="{{ asset('images/tinybanner/tinybanner-2.png') }}" alt="" width="580" height="190">
				</figure>
			</a>
		</div>
	</div>
				...
				<div class="product-img">
					...
					<div class="button-head">
						...
						<div class="product-action-2">
							<a title="Add to cart" href="{{ route('add_to_cart',['id'=>$product->id]) }}">Add
								to
								cart</a>
						</div>
					...
					<div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5"
						...
						<div class="product product-style-2 equal-elem ">
							...
							<div class="product-info">
								...
								<div class="wrap-price"><span class="product-price">${{$c_product->price}}</span></div>
							</div>
						</div>
						@endforeach
					</div>
