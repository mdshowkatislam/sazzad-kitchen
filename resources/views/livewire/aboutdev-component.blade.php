                ...
                <div class="item-slide">
                    ...
                    <div class="slide-info slide-1">
                        ...
                        <p class="sale-info" style="color:red !important;"> <span class="price"
                                style="color:green !important;">{{$slide->price}}</span>
                        </p>
    ...
    <section class="welcome-area section-padding2">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-6 align-self-center">
                    <div class="welcome-img">
                        <img src="{{ asset('images/aboutus') }}/{{ $info3->image }}" class="img-fluid" alt="">
                    </div>
                </div>
                <div class="col-md-6 align-self-center">
                    <div class="mt-5 welcome-text mt-md-0">
                        <h3><span class="style-change">{{ $info3->title1 }}</span> <br>{{ $info3->title2 }}</h3>
                        <p class="pt-3">
                            {{ $info3->doc }}
