                ...
                <div class="panel-body">
                        ...
                        <ul class="products-cart">
                            ...
                            <li class="pr-cart-item">
                                <div class="product-image">
                                    <figure><img src="{{ asset('images/products') }}/{{$item->product->image}}"
                                            alt="{{$item->product->name}}"></figure>
                                </div>

                                <div class="product-name">
                                    <a class="link-to-product"
                                        href="{{route('detail',['id'=>$item->product->id])}}">{{$item->product->name}}</a>
                                </div>
                                ...
                                <div class="price-field sub-total">
                                    <p class="price">
                                        ...
                                        <a href="{{route('user.review',['order_items_id'=>$item->id])}}">Write
                                            Review</a>
                    ...
                    <div class="summary">
                        <div class="order-summary">
                            ...
                            <p class="summary-info"><span class="title">Tax</span><b class="index">${{$order->tax}}</b>
                            </p>
