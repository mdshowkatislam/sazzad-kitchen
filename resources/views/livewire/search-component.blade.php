    ...
    <div class="container">
        ...
        <div class="wrap-breadcrumb">
            <ul>
                ...
                <li class="item-link"><span>cumillastore</span></li>
            </ul>
        </div>
        <div class="row">
            ...
            <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
                ...
                <div class="banner-shop">
                    <a href="#" class="banner-link">
                        <figure><img src="{{ asset('assets/images/shop-banner.jpg') }}" alt="">
                        </figure>
                    </a>
                </div>
                ...
                <div class="wrap-shop-control">
                    ...
                    <h1 class="shop-title">cumillastore</h1>
                                ...
                                <li class="col-lg-4 col-md-6 col-sm-6 col-xs-6 ">
                                    <div class="product product-style-3 equal-elem ">
                                        ...
                                        <div class="product-info">
                                            ...
                                            <a href="#" class="btn add-to-cart" wire:click.prevent="store({{ $product->id }}, '{{ $product->name }}', 
                      {{ $product->price }})">AddTo Cart</a>
                                        </div>
                                    </div>
                                </li>
                            @endforeach
