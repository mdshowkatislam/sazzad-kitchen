                        ...
                        <form class="form-horizontal" wire:submit.prevent="updateSlide">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    ...
                                    @else
                                    <img src="{{asset('images/MainSliders')}}/{{$image}}" width="120" />
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <select class="form-control" wire:model="status">
                                        <option value=" ">select Status please</option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <select class="form-control" wire:model="group">
                                        <option value=" ">Enter your group or category</option>
                                        <option value="main">main banners</option>
                                        <option value="software">software company banners</option>
                                        <option value="company">company banners</option>
                                    </select>
                                </div>
                            </div>
